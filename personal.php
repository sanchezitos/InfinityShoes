        ...
        <html>
            ...
            <div class="opciones" id="opciones">
                <div class="list-group">
                    <button type="button" class="list-group-item" onclick="return regven(event)">Registrar vendedor</button>
                    <button type="button" class="list-group-item" onclick="return edtperf(event)">Editar perfil</button>
                    <button type="button" class="list-group-item" onclick="return eliperf(event)">Eliminar vendedor</button>
                </div>
            </div>
